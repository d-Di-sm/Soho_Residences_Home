...
function App() {
  ...
  const tourMappings = {
    "2BR_G_A": {
      ...
      camRot: [95, 105, 90, 90, 95, 90, 30, 35, 120],
      spaces: [
        "Lobby",
        "Lobby Bedroom",
        "Hall",
    ...
    "2BR_G_B": {
      ...
      camRot: [95, 75, 90, 90, 85, 90, 150, 140, 100],
      spaces: [
        "Lobby",
        "Lobby Bedroom",
        "Hall",
    ...
    "3BR_G_A": {
      ...
      camRot: [90, 0, 80, 20, 84, 90, 95, 90, 170, 90, 20, 90, 90, 90],
      spaces: [
        "Lobby",
        "Living 1",
        "Living 2",
    ...
    "3BR_G_B": {
      ...
      camRot: [90, 180, 90, 160, 96, 90, 86, 90, 15, 85, 160, 85, 90, -130],
      spaces: [
        "Lobby",
        "Living 1",
        "Living 2",
    ...
    "4BR_A": {
      ...
      camRot: [
        90, 5, 93, 90, 90, 90, 110, 90, 90, 5, 85, 90, 95, 90, 83, 80, 120,
      ],
      spaces: [
        "Lobby",
        "Living",
    ...
    "4BR_B": {
      ...
      camRot: [
        90, 180, 90, -120, 90, 90, 75, 75, 90, 175, 90, 90, 90, 90, 100, 100,
        100,
      ],
      spaces: [
        "Lobby",
    ...
    CA_01: {
      ...
      camRot: [95, 80, -130, 70, 115, -55, 90, 45, 90, 90, 48, 120, 90, 90],
      spaces: [
        "Entrance",
        "Terrace 1",
        "Terrace 2",
        ...
        <>
          ...
          >
            <Recorrido360
              ...
              camRot={
                returnToMesh && tourMappings[returnToMesh]
                  ? tourMappings[returnToMesh].camRot
                  : undefined
              }
              shouldFlipTextures={
